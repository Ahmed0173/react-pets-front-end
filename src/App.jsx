...
const App = () => {
  ...
  const handleDeletePet = async (petId) => {
    try {
      ...
      console.log('Delete response:', deletedPet);

      if (deletedPet.err) {
        throw new Error(deletedPet.err);
      }

      // Filter out the deleted pet using the petId parameter instead of deletedPet._id
      // in case the backend doesn't return the full pet object
